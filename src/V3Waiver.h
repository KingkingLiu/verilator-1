...
public:
    static void addEntry(V3ErrorCode errorCode, const string& filename, const std::string& str) VL_MT_SAFE;
    static void write(const std::string& filename) VL_MT_SAFE;
};
